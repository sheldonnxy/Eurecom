...
def plot_uav_trajectory(uav_trj, fig_id, line_style='-', line_width=2, color=None, marker='', marker_size=5):
    plt.figure(fig_id)
    plt.plot(uav_trj[:, 0], uav_trj[:, 1], lw=line_width, c=color, marker=marker)
    plt.show()
